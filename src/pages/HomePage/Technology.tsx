...
const systemStrength = [
    ...
    },
    {
        ...
        "description": "Tingkat akurasi hingga 95% dalam prediksi harga rumah di Bandung berdasarkan data riil."
    },
    {
        "title": "Prediksi Regresi Linear",
        "description": "  Menggunakan model regresi lanjutan (XGBoost) yang mampu menangkap pola kompleks dari berbagai fitur rumah seperti lokasi, luas tanah, dan jumlah kamar."
    }
]
