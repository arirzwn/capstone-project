const aboutList = [
    ...
    {
        svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="size-6">
...
function About() {
    return (
        <section className="flex flex-col gap-5 px-10 py-20 pb-20 items-center min-h-[calc(80vh)]" id="about-section">
            ...
            <div className="flex gap-5 flex-wrap items-start justify-center">
                {aboutList.map((aboutItem) => {
                    return (
                        <div className="flex flex-col gap-2 items-center text-center justify-center bg-indigo-100 rounded-lg p-5 max-w-[30rem] aspect-video relative">
